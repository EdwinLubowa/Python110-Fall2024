# ------------------------------------------------- #
# Title: Lab01 - Working with Inheritance
# # Description: Demonstrates how to use Inheritance in a class
...
# Edwin Kintu-Lubowa,11/23/2024,Added Inheritance
# ------------------------------------------------- #
import json
...
# TODO 5. Add code to inherit code from the person class
    def __str__(self):
...
class Student(Person):
    ...
    # TODO 6 Comment out the code for the first_name and last_name properties
    # @property  # (Use this decorator for the getter or accessor)
    # def first_name(self):
    #     return self.__first_name.title()  # formatting code
    #
